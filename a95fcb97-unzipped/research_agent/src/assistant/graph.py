...
def summarize_sources(state: SummaryState, config: RunnableConfig):
    ...
    # Guard: if no actual search content, return a placeholder
    if not most_recent_web_research or most_recent_web_research.strip() == "Sources:":
        fallback = f"No web search results were found for: {state.research_topic}. Analysis is based on prior knowledge."
